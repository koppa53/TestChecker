...
#execute the program
button = Button(gui, text = 'Get Started', bg='#536DFE', fg='white', activebackground='#F2F2F2')  
button['font'] = myFont
button.pack()  
...
select_ans = Button(gui, text = 'Browse', bg='#536DFE', fg='white', activebackground='#F2F2F2', command = click_ans)  
